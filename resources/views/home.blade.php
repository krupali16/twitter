...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="/download">Download Tweets</a></li>
      <li data-toggle="modal" data-target="#myModal"><a href="#">Email Tweets</a></li>
    </ul>
      
    <ul class="nav navbar-nav navbar-right">
      <li><a href="#"><span class="glyphicon glyphicon-user"></span> {{$token['screen_name']}}</a></li>
